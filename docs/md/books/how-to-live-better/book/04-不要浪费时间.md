...
- 收益：把 94 项独立检验合起来算，先把打算写成「如果……就……」（心理学里叫实施意图）的人目标达成率提高，效果大小 d = 0.65（算中到大），覆盖开始行动、抵御干扰、从注定失败的事上撤出等环节
- 证据等级：A
...
- 说人话：开工前先写好「到某月某日还没达到某指标就停」。把多项「如果……就……」研究合起来算的结果显示，这种写法也帮人从注定失败的事上撤下来。省下的是本来还会继续往里砸的全部时间。
- 收益：把多项实施意图研究合起来算的分析显示，预先设定的「如果……就……」同样帮人「从注定失败的事上撤出来」（原文 disengagement from failing courses of action）；省下的是本来会继续投进去的全部时间
- 证据等级：B
- 来源：Gollwitzer, P. M., & Sheeran, P. (2006). Implementation intentions and goal achievement: A meta-analysis of effects and processes. Advances in Experimental Social Psychology, 38, 69–119. <https://doi.org/10.1016/S0065-2601(06)38002-1>
...
- 收益：已投入的钱、精力、时间会让人更倾向继续（这叫沉没成本效应），把 98 组数据合起来算的分析确认这种倾向稳定存在；避开它省下的是被「不想浪费」绑住的后续时间
- 证据等级：B
...
- 收益：学生预计 33.9 天完成论文，实际 55.5 天，只有 29.7% 按自己的估计按时完成；被要求把过去经历和当前任务挂钩后，按时完成比例从对照组的 29.3% 升到 60.0%，把工期往少了估的那种乐观不再出现
- 证据等级：B
...
- 收益：两项调查（958 人和 292 人）中，会前发了议程的会，参会者更容易觉得这个会有效果，这一关系在统计上站得住；实验中 55 组坐着开会比 56 组站着开会时长多 34%，决策质量没有差别
- 证据等级：B
...
- 收益：每周工作 35 小时以上的员工中（676 人和 304 人两项调查），开会占掉多少时间会怎样影响工作态度和幸福感，要看会开得好不好、这个岗位干活多依赖别人；让人连记一周日记的研究显示，当天开会次数越多，疲劳和自己感觉到的工作量越高。省下的时间等于砍掉的会议时长本身
- 证据等级：B
...
- 收益：人们估工期时不会自己把一件多头的任务拆成几块（写文献综述、写讨论、整理参考文献等），先列出子任务再估，能少犯把工期估短的毛病（规划谬误）；拆开后每一小步都成为一个可以立刻开始的动作，也降低拖延（最能预示拖延的因素包括对任务的厌恶感和任务延迟）
- 证据等级：B
...
- 收益：有外部截止的学生 80.6% 在截止前完成，而只有 38.7% 在自己预计的时间内完成；什么时候做完几乎跟着截止日期走（相关系数 r = 0.82），和自己的预计只有很弱的关系
- 证据等级：B
...
- 收益：中国居民家务劳动每日平均 1 小时 17 分钟，做家务的人平均 1 小时 59 分钟（2024 年调查，3.85 万户 10.7 万人）；四国 6271 人的样本里，花钱买时间的人生活满意度更高，在真实生活里做的实验中，同一笔钱花在买时间上比买实物带来更高的当下幸福感
- 证据等级：B
...
- 说人话：中国人平均每天上网 5 小时 37 分，当天真上了网的人是 6 小时 3 分；2018 年按同样算法还只有 2 小时 42 分。这是本节时间账里数字最大的一项，砍掉其中一小时，一年就多出 365 小时。
- 收益：中国居民互联网使用每日平均 5 小时 37 分钟，当天真上了网的人平均 6 小时 3 分钟，92.9% 的人当天用过网（2024 年）；2018 年按同样算法为 2 小时 42 分钟。这是本节里数字最大的一项，砍掉其中一小时等于每年多出 365 小时
- 证据等级：C
...
- 收益：251 名有经验的 Word 用户中，多数人很少使用更高效的快捷键，仍以图标工具栏为主；分组对比的实验确认快捷键是三种方式中最快的。省回的时间随每天操作次数累积，长期做同一类工作的人收益最大
- 证据等级：B
...
- 收益：中国居民交通活动每日平均 50 分钟，当天有出行的人 1 小时 2 分钟（2024 年）；德国长期跟踪同一批人的数据显示，通勤越长的人主观幸福感稳定地更低，且没有在收入或住房上得到补偿；把多项研究梳理到一起的综述确认，通勤时间越长对通勤越不满意，和用什么交通方式无关。单程少 30 分钟，每周约省 5 小时
- 证据等级：B
