...
如果你对 Linux 网络和高性能编程感兴趣，想真正上手做项目，我有四门课可以帮你打好基础：C 语言快速入门：大一啃完谭浩强的书，还是不会写代码？我花1个月做了套'12天速成'的C语言课C++ 快速入门：12天，从C++小白到独立做项目！我把3年踩坑经验浓缩成了这门课Linux 编程快速入门：为什么你学了半年 Linux 编程，还是写不出一个像样的程序？Linux io_uring 课程：会 epoll 又怎样？不懂 io_uring，你的服务器性能永远差那口气除了基础课程，近 10 个月来，小康陆续完成了21个 C++ 硬核项目课程：线程池、内存池、MySQL连接池、日志库、无锁队列、协程库、高性能网络库、LSM 存储引擎、WebSocket 聊天室、FlashHTTP Server、Mini-STL、Mini-Redis…… 带领 420+ 同学从零实现这些项目，每个都是能跑、能上简历的那种。项目详情查看：小康的 C++ 项目实战课程目录｜持续更新对项目感兴趣加我微信：jkfwdkf，备注「项目实战」，打包有优惠。或者扫码加小康微信:![image](https://mmbiz.qpic.cn/mmbiz_png/tpRianG0SsmibgvUIuNnIs1zjwX7VkVdibN3lgfsrUXT0GHXazibyjcMglH9ukLr9kSictRzYOIRqoRdYhiaTZ3dibCuVkc7jGNC3ibfo8fvrQyPq28/640?wx_fmt=png&from=appmsg#imgIndex=4)

如果你对 Linux 网络和高性能编程感兴趣，想真正上手做项目，我有四门课可以帮你打好基础：
...
Linux io_uring 课程：会 epoll 又怎样？不懂 io_uring，你的服务器性能永远差那口气

除了基础课程，近 10 个月来，小康陆续完成了21个 C++ 硬核项目课程：线程池、内存池、MySQL连接池、日志库、无锁队列、协程库、高性能网络库、LSM 存储引擎、WebSocket 聊天室、FlashHTTP Server、Mini-STL、Mini-Redis…… 带领 420+ 同学从零实现这些项目，每个都是能跑、能上简历的那种。

项目详情查看：小康的 C++ 项目实战课程目录｜持续更新

对项目感兴趣加我微信：jkfwdkf，备注「项目实战」，打包有优惠。
