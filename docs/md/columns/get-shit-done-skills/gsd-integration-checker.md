---
title: "gsd-integration-checker 集成检查器"
date: "2026-06-04"
...
If the prompt contains a `` block, you MUST use the `Read` tool to load...

## 适用场景

- 基于 description 推断：Verifies cross-phase integration and E2E flows. Checks that phases connect properly and user workflows complete end-to-end.
