...
- Read the ROADMAP.md phase...

## 适用场景

- 基于 description 推断：Deeply analyzes codebase for a phase and returns structured assumptions with evidence. Spawned by discuss-phase assumptions mode.
