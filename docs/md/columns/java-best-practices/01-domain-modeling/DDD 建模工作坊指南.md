...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [domain-driven-design.org](https://domain-driven-design.org/zh/ddd-design-workshop-guide.html)
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/process.png)DDD 建模的基本原理
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/scene-map.png)场景地图
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/sotorming-case.png)风暴图例

示例
--

![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/event-storming.png)事件风暴
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/command-storming.png)命令风暴
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/modling.png)识别模型
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/modeling-case.png)模型图例
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/modeling-extract.png)模型展开
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/context-mapping.png)上下文映射

由于我们的示例比较简单，这里再补充一个复杂的示例。

![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/context-mapping-2.png)上下文映射 - 2
...
![](https://domain-driven-design.org/zh/ddd-design-workshop-guide/uml-model.png)UML 输出
