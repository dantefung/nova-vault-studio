...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [domain-driven-design.org](https://domain-driven-design.org/zh/ddd-concept-reference.html)

> DDD 是 Domain-Driven Design 的缩写，本文档提供了 DDD 的标准化释义。

![](https://domain-driven-design.org/zh/ddd-concept-reference/concept-map-hd.png)DDD 基本概念图
