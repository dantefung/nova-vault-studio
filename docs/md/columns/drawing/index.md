...
```mermaid
graph TD
    A[绘图指南专栏] --> B[第一章<br/>01-概念入门]
    A --> C[第二章<br/>02-SVG绘图]
    A --> D[第三章<br/>03-UML绘图]
    A --> E[第四章<br/>04-AI生图]
    A --> F[第五章<br/>05-架构图]
    A --> G[第六章<br/>06-Drawio]
    A --> H[第七章<br/>07-工具]
```
...
- [04-04 我整理了 42 种艺术风格图鉴](./04-04-ai-image/04-04-42-art-styles.md) — 42 种艺术风格的特征解析与生图 Prompt 模板
