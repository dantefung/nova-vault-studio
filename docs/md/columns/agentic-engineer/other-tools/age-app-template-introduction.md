---
title: "超越Harness Engineering: AGE 应用开发模板介绍"
date: "2026-05-23"
source: "微信公众号 可逆计算"
url: "https://mp.weixin.qq.com/s/DsLQTrALYFrtAJlhrG5bOw"
---

# 超越Harness Engineering: AGE 应用开发模板介绍

> 来源：微信公众号「可逆计算」，2026-05-23
...
**参考文章：**
- [从 Spec-Driven Development 到 Attractor-Guided Engineering](https://example.com)：AGE 不是 spec-driven workflow 的替代包装，而是以带 precedence 的 owner docs 定义 attractor、再通过 harness 让仓库轨迹持续收敛的工程框架。
- [Attractor Before Harness: AI 大规模开发的方法论](https://example.com)：在 AI 大规模开发中 attractor（吸引子）必须先于 harness（控制机制）作为方法论的一等公民。
...
高风险/高模糊性的需求、设计、Plan：使用独立子 Agent 审查。审查者必须引用文件和证据，修订直到主要异议解决。
...
1. **A. 生成设计文档** — 需求设计 vs 架构设计分开写，互相引用，独立审查
2. **B. 根据设计文档生成 Plan** — 从稳定基线出发，独立审查
3. **C. 定期审计** — 文档审计 + 计划审计 + 闭包审计
