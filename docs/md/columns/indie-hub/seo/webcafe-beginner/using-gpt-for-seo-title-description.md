---
title: "如何用 GPT生成SEO 友好的网页Title和Description"
date: "2024-07-29"
source: "web.cafe"
author: "哥飞"
...
# 如何用 GPT生成SEO 友好的网页Title和Description
...
所以今天哥飞给大家演示一下，哥飞平常上线一个网站，是怎么让GPT辅助编写SEO 友好的网页Title和Description。
...
`我正在做 https://chinesenames.ai/ ，网站名称是 ChinsesNames.ai ，这是一个帮助非中国人起中国名字的工具类网站，同时也包含各种中国人名的解释信息。 请帮我写符合SEO规范的首页Title，要求SEO 友好，覆盖网站名称和核心关键词 Chinses Names。 请参考以下用户经常会在谷歌搜索的关键词，从上到下分别是按照搜索量从高到低排序： chinese names chinese first names male chinese family names chinese surnames chinese last names （限于篇幅，此处省略95个关键词，大家自己使用时补充完整）`

GPT 的回复如下：
![image.png](images/using-gpt-for-seo-title-description/img_004.png)

但是不符合哥飞的要求，于是哥飞继续提需求：
![image.png](images/using-gpt-for-seo-title-description/img_005.png)

“Generated”不是哥飞想要的关键词，于是继续提新需求：
![image.png](images/using-gpt-for-seo-title-description/img_006.png)

这时候给出的标题已经差不多达标了，但是哥飞有更高的要求，基于 GPT给出来的，哥飞自己写了一版，让GPT润色。
![image.png](images/using-gpt-for-seo-title-description/img_007.png)

标题一般要求小于 60个字符，所以哥飞还要求继续缩短了一些，但是GPT写的还是太长了，于是哥飞自己又写了一版，让GPT继续润色。
![image.png](images/using-gpt-for-seo-title-description/img_008.png)

“Interpreter” 这个单词不是哥飞 想要的，太专业了，普通人不太会写这个单词，于是让GPT从哥飞之前给出的关键词列表里找一个单词。
![image.png](images/using-gpt-for-seo-title-description/img_009.png)
...
最终，哥飞如愿得到了SEO 友好的网页Title和Description。
