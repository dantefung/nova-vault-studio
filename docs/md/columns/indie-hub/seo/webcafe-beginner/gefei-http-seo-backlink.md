...
这是上周，哥飞在社群里的一次分享，这次分享的知识属于特别基础，但又不是每个人都了解清楚的，所以今天哥飞在公众号里也分享一下全文。
...
![image](./images/001.png)哥飞备注：图片由Claude生成，能够理解意思即可，细节不用深究
...
如果是HTTPS，则在客户端和服务端进行了加解密，加密后传输的是二进制数据。
