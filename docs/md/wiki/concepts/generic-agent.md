---
title: "GenericAgent（自我进化AI Agent框架）"
date: "2026-06-11"
---

# GenericAgent（自我进化AI Agent框架）

> Self-evolving agent: grows skill tree from 3.3K-line seed, achieving full system control with 6x less token consumption. 极致精简 + 自我进化。

## Key Points

- **设计哲学**：不要预设技能，靠进化获得能力。每解决一个新任务，GenericAgent 将执行路径自动固化为 Skill，存入分层记忆系统
...
- **极致省 Token**：上下文 <30K，6 倍 token 节省
...
- **12.5k Stars** · **1.4k Forks** · **800 Commits**
- Python 89.8% · JavaScript 6.6%
- arXiv 技术报告

## Sources

- GitHub lsdefine/GenericAgent (2026-06-04)