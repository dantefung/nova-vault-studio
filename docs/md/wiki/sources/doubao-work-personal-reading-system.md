...
![image](../images/doubao-work-personal-reading-system/001.jpg)
...
![image](../images/doubao-work-personal-reading-system/002.png)

存储就是，把定时抓取的内容都存在飞书文档、飞书多维表格里。

![image](../images/doubao-work-personal-reading-system/003.jpg)

展示用豆包工作基于上面多维表搭建一个公开的页面。发送下面提示词，用 AI 根据多维表格存的数据来搭建。

![image](../images/doubao-work-personal-reading-system/004.png)

最后得到一个在任何终端都能看的到的信息流。

![image](../images/doubao-work-personal-reading-system/005.png)

点击就可以看文章的标题、摘要、原文链接。

![image](../images/doubao-work-personal-reading-system/006.png)
...
![image](../images/doubao-work-personal-reading-system/007.png)
...
![image](../images/doubao-work-personal-reading-system/008.png)

我把定时任务都迁移到了这豆包工作里，一切体验都 All in one。我可以随时随地，打开手机上的飞书就能看到抓取的内容，保存到了飞书文档里。我还可以继续和豆包工作对话，进一步研究。

![image](../images/doubao-work-personal-reading-system/009.png)
...
![image](../images/doubao-work-personal-reading-system/010.png)

我做的阅读页面是两列卡片布局：每张卡片左边是封面，右边是标题、来源标签和一句话摘要。内容完全是为我定制的。

![image](../images/doubao-work-personal-reading-system/011.png)
