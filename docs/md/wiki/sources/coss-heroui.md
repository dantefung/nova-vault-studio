---
title: "COSS UI + HeroUI：比 shadcn/UI 更漂亮的两款 React 组件库"
date: "2026-06-04"
source: "X/Twitter"
url: "https://x.com/i/status/2061688102025093246"
---

# COSS UI + HeroUI：比 shadcn/UI 更漂亮的两款 React 组件库

> 两个简洁美观的 React 组件库替代品：COSS UI（基于 Base UI，简洁考究，AI 友好）+ HeroUI（色彩鲜艳，theme 丰富可定制）
...
**Agent 资源亮点**：
- `/.well-known/llms.txt` + `llms-full.txt`
