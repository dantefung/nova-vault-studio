---
title: "geju（格局）—专治 Codex 过度谨慎的 Skill，让 AI 格局打开"
date: "2026-06-04"
source: "GitHub"
...
`geju` 不是为了产出百分百正确的答案，而是产出有启发性、有杠杆、能打开设计空间的**强假设**。把 thesis 当作需要验证的假设，而不是神谕。
...
- 安装：`git clone https://github.com/hylarucoder/hai-stack.git && cd hai-stack && make link`