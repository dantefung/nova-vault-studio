---
title: "Public Suffix List (公共后缀列表)"
date: "2026-08-22"
source: "Mozilla Public Suffix List"
url: "https://publicsuffix.org/list/public_suffix_list.dat"
---

# Public Suffix List (公共后缀列表)

> 公共后缀列表（Public Suffix List）是由 Mozilla 维护的权威域名后缀列表，用于区分域名注册层级。
> 当前版本：2026-08-19，提交哈希：e8c9a2b2b2856b6449999dd0ec0d118f364ed0cd
