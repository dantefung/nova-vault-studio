---
title: "santifer/career-ops — AI 求职系统（51.2k Stars）"
date: "2026-06-09"
source: "GitHub"
url: "https://github.com/santifer/career-ops"
---

# santifer/career-ops — AI 求职系统（51.2k Stars）
...
将求职（修改简历/JD 匹配/面试追踪）变成可用代码管理的自动化 DevOps 流。作者用它评估了 740+ 职位，生成了 100+ 份定制简历，最终斩获 Head of Applied AI offer。
...
- Claude Code（Agent）+ Playwright（浏览器自动化）+ Go TUI（Bubble Tea）+ Node.js
