...
```mermaid
graph TD
    A[VSCode Markdown工具] --> B[预览增强]
    A --> C[绘图工具]
    A --> D[格式化]
    B --> B1[Markdown Preview]
    C --> C1[Draw.io]
    C --> C2[PlantUML]
    C --> C3[Excalidraw]
    C --> C4[Mermaid]
...
[![](https://github.com/hangcheng/Markdown-VScode-Template/raw/main/template.png)](/hangcheng/Markdown-VScode-Template/blob/main/template.png)
