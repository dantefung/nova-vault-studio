...
> - v2026.4.22 起安装向导会**自动安装缺失的 provider 和 channel 插件**
> - v2026.4.24 引导向导默认模型切换为 **DeepSeek V4 Flash**（V4 Pro 亦可选）
> - **版本号**：下文若出现 `openclaw@具体版本` 或固定 Docker tag，多为历史示例；**稳定版参考**为 **v2026.4.24**，**当前推荐线**以你执行安装时 npm / 镜像站展示的 **`latest`、官方 [Releases](https://github.com/openclaw/openclaw/releases)（含预发布）** 及 **`openclaw --version`** 为准，不要机械照抄旧版本号。
